...
\begin{snippet}{metricspaces-distance-function-definition}
\sdefinition{Distance Function}{
    Let \(X\) be a set.
...
\begin{snippet}{metricspaces-metric-space-definition}
\sdefinition{Metric Space}{
...
\begin{snippet}{metricspaces-reverse-triangle-inequality}
\slemma{Reverse triangle inequality}{
    Given a metric space \((X,d)\). Let \(x,y,z \in X\).
    Then, \[|d(x,y) - d(x,z)| \leq d(y,z)\]
}
\end{snippet}

\begin{snippet}{metricspaces-reverse-triangle-inequality-proof}
\sproof{Reverse triangle inequality}{
...
\begin{snippet}{metricspaces-open-ball-definition}
\sdefinition{Open Ball}{
...
\begin{snippet}{metricspaces-closed-ball-definition}
\sdefinition{Closed Open Ball}{
    Let \((X, d)\) be a metric space.
...
\begin{snippet}{metricspaces-bounded-set}
\sdefinition{Bounded Set}{
...
\begin{snippet}{metricspaces-boundness-equivalence}
\slemma{todo}{
    Let \((X, d)\) be a metric space and \(Y \subseteq X\).
...
\begin{snippet}{metricspaces-boundness-equivalence-proof}
\sproof{todo}{
    TODO
}
\end{snippet}
