...
\begin{snippet}{taylor-series-definition}
\sdefinition{Taylor Series}{
...
\begin{snippet}{power-rule-nth-derivative}
\sproposition{\(n\)-th derivative of \(x^n\)}{
...
\begin{snippet}{power-rule-nth-derivative-proof}
\sproof{\(n\)-th derivative of \(x^n\)}{
    \begin{align*}
...
\begin{snippet}{taylor-series-derivation}
\sproof{Taylor Series}{
