...
\begin{snippet}{de-moivres-theorem}
\stheorem{De Moivre's Theorem}{
...
\begin{snippet}{de-moivres-theorem-proof}
\sproof{De Moivre's Theorem}{
...
\begin{snippet}{nth-root-of-unity-definition}
\sdefinition{Nth root of unity}{
    An \textit{nth root of unity} is a solution to
    \[
        z^n=1
    \]
    where \(z \in \mathbb{C}\) and \(n \in \mathbb{N}\).
}
\end{snippet}

\begin{snippet}{nth-root-of-unity-solution}
\stheorem{Nth roots of unity}{
...
\begin{snippet}{nth-root-of-unity-solution-proof}
\sproof{Nth roots of unity}{
...
The roots of unity have the same angle \(\alpha = \frac{2\pi}{n}\) between eachother.
\\
