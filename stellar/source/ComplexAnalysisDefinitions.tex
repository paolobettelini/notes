...
\begin{snippet}{riemann-sphere-definition}
\sdefinition{Riemann Sphere}{
...
\begin{snippet}{open-disk-definition}
\sdefinition{Open Disk}{
...
\begin{snippet}{closed-disk-definition}
\sdefinition{Closed Disk}{
...
\begin{snippet}{circle-definition}
\sdefinition{Circle}{
...
\begin{snippet}{interior-point-definition}
\sdefinition{Interior Point}{
...
\begin{snippet}{boundary-point-definition}
\sdefinition{Boundary Point}{
    \(z\) is a boundary point of \(\Omega\) iff every open disk at \(z\)
    contains points both in \(\Omega\) and not in \(\Omega\).
}
\end{snippet}

\begin{snippet}{exterior-point-definition}
\sdefinition{Exterior Point}{
    The point \(z\) is an exterior point of \(\Omega\) iff it is not a boundary
    point of an interior point.
}
\end{snippet}

\begin{snippet}{accumulation-point-definition}
\sdefinition{Accumulation Point}{
...
\begin{snippet}{open-set-definition}
\sdefinition{Open Set}{
    A set \(\Omega\) is \textit{open} if all points in \(\Omega\)
    are interior points of \(\Omega\).
}
\end{snippet}

\begin{snippet}{closed-set-definition}
\sdefinition{Closed Set}{
    A set \(\Omega\) is \textit{closed} if every accumulation point of \(\Omega\)
    is in \(\Omega\). 
}
\end{snippet}

\begin{snippet}{bounded-set-definition}
\sdefinition{Bunded Set}{
...
\begin{snippet}{connected-set-definition}
\sdefinition{Connected Set}{
