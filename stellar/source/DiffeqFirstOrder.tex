...
\begin{snippet}{diffeq-constant-coeff-sol}
\stheorem{Constant Coefficients Differential Equations}{
...
\begin{snippet}{diffeq-constant-coeff-sol-proof-1}
\sproof{Constant Coefficients Differential Equations}{
...
\begin{snippet}{diffeq-constant-coeff-sol-proof-2}
\sproof{Constant Coefficients Differential Equations}{
...
\begin{snippet}{diffeq-constant-coeff-ivp-sol}
\stheorem{Ordinary Constant Differential Equation with IV}{
...
\begin{snippet}{diffeq-constant-coeff-ivp-sol}
\sproof{Ordinary Constant Differential Equation with IV}{
...
\begin{snippet}{diffeq-linear-diffeq}
\sdefinition{Linear Differential Equation}{
...
\begin{snippet}{diffeq-linear-coeff-sol}
\stheorem{Theorem}{
...
\begin{snippet}{diffeq-linear-coeff-sol-proof}
\sproof{Theorem}{
...
\begin{snippet}{diffeq-linear-var-coeff-sol}
\stheorem{Theorem}{
    The general solution to the differential equation
    \[
        y'=a(t)y(t)+b(t)
...
\end{snippet}
\begin{snippet}{diffeq-linear-var-coeff-sol-proof}
\sproof{Theorem}{
    TODO
}
\end{snippet}
...
\begin{snippet}{bernoulli-equation-definition}
\sdefinition{Bernoulli Equation}{
...
\begin{snippet}{bernoulli-equation-sol}
\stheorem{Theorem}{
...
\begin{snippet}{bernoulli-equation-sol-proof}
\sproof{Theorem}{
...
\begin{snippet}{separale-equation-definition}
\sdefinition{Separale Equation}{
...
\begin{snippet}{separale-equation-sol}
\stheorem{Theorem}{
...
\begin{snippet}{separale-equation-sol-proof}
\sproof{Theorem}{
...
\begin{snippet}{exact-equation-definition}
\sdefinition{Exact Equation}{
...
\begin{snippet}{homogenous-equation-definition}
\sdefinition{Homogeneous Equation}{
...
\begin{snippet}{slope-field-definition}
\sdefinition{Slope Field}{
...
\begin{snippet}{euler-method}
\sdefinition{Euler's Method}{
