...
\begin{center}
    % https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZARgBoAGAXVJADcBDAGwFcYkQBBEAX1PU1z5CKAEwVqdJq3YAhHnxAZseAkXLiaDFm0Sd5-ZUKJliErdN0BhHhJhQA5vCKgAZgCcIAWyRiQOCEgAzJpSOiAuIDSM9ABGMIwACgIqwiBuWPYAFjj64R7eiGR+AYjBktrs9rnuXkjqxUFRWGBhUPRwmXaR5RYgADp9AMaZWNX5PjT+dZP0WIzsmRAQANbd5mFYAPpcvK7jhZMl9evsW3IzcwtLq9yU3EA
    \begin{tikzcd}
    A \arrow[rd, "f"'] \arrow[r, "i_A", hook] & A \arrow[d, "\chi", dashed] & B \arrow[ld, "g"] \arrow[l, "i_B", hook] \\
                                            & C                           &                                         
    \end{tikzcd}
\end{center}
...
\sdefinition{}{
    A diagram \(D\) in a category \(\mathcal{D}\)
