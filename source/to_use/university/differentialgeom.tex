...
\begin{snippetproposition}{}
    ...
    \]
    dove il valore assoluto è il modulo \(\sqrt{\langle v, \rangle v}\).
...
\begin{snippetproof}{}
    ...
    \begin{align*}
        ...
        &= \frac{\sigma''|\sigma'| - \sigma' \frac{d}{dt} \sqrt{\langle \sigma', \rangle \sigma'}}{|\sigma'|^2} \cdot \frac{1}{|\sigma'|} \\
        &= \frac{
            \sigma''|\sigma'| 
            - \sigma' \cdot \frac12 \langle \sigma', \sigma'\rangle^{-1/2} 
            \cdot 2 \cdot \langle \sigma'', \sigma'\rangle}{
            |\sigma'|^2
        } \cdot \frac{1}{|\sigma'|} \\
    ...
    \begin{align*}
        ...
        \right| \\
        &= \sqrt{
            \langle \frac{\sigma''}{|\sigma'|^2} - \sigma' \frac{\langle \sigma'', \sigma'\rangle}{|\sigma'|^4} \rangle,
            \langle \frac{\sigma''}{|\sigma'|^2} - \sigma' \frac{\langle \sigma'', \sigma'\rangle}{|\sigma'|^4} \rangle
        } \\
        &= \sqrt{
            \frac{\langle \sigma'', \sigma'\rangle}{|\sigma'|^4}
            - 2 \frac{\langle \sigma'', \sigma'\rangle}{|\sigma'|^6}
            + \frac{\langle \sigma', \sigma'\rangle\langle \sigma'', \sigma'\rangle^2}{|\sigma'|^8}
        } \\
        &= \sqrt{
            \frac{
                |\sigma''|^2 |\sigma'|^2 - 2\langle \sigma'', \sigma'\rangle + \langle \sigma'', \sigma'\rangle^2
            }{
                |\sigma'|^6
            }
        } \\
    ...
    \end{align*}
    Potrebbe esserci un quadrato mancante negli ultimi passaggi. TODO.
\end{snippetproof}
...
\begin{snippetdefinition}{Inviluppo}
    Una curva \(\sigma \colon I \fromto \realnumbers^2\)
...
\begin{snippetproposition}{}
    Ogni curva piana regolare è inviluppo della faimglia delle sue rette tangenti.
\end{snippetproposition}
...
\begin{tikzpicture}[scale=0.9]
    \definecolor{giallino}{RGB}{255,255,200}
    ...
    \fill[giallino] (P) -- ++(-67:0.4) arc (-67:25:0.4) -- cycle;
    ...
    \draw[red, thin] (T2) -- (T1) node[right, black] {$b$};
...
\end{tikzpicture}
    ...
    \(PF_2\) e \(PF_1\). Vogliamo dimostrare che \(b\) è tangente all'allisse in \(P\).
