...
\begin{snippetproposition}{Proprietà del prodotto vettoriale}
    \begin{enumerate}
...
\begin{snippettheorem}{Teorema del flusso di Gauss}
...
\begin{snippetexample}{Se ci trovassimo sul fondo di un buco sulla superficie terrestre
...
\begin{snippetexercise}{Un ascensore sale con accelerazione costante
...
\begin{snippetexercise}{Una pallina si trova ferma alla base di un piano inclinato di \(\alpha\)
...
\begin{snippetexercise}{Un punto materiale di massa \(m\) è appeso tramite una molla di costante
    elastica \(k\) ad un supporto che avanza con accelerazione \(a\).
    Clcolare l'allungamento della molla.}
\end{snippetexercise}

\begin{snippetexercise}{Un piano inclinato 3-4-5 è fissato su una piattaforma rotante. Un blocco è posizionato
...
\begin{snippetexercise}{7.6}
\end{snippetexercise}

\begin{snippetexercise}{7.7}
    \[
