...
\sexercise{}{
    ...
    \begin{align*}
        ...
        \right)\,d\mu(x)
    \end{align*}
    Chiamiamo la \(x\)-sezione \(E_x = \{ y\in \realnumbers \,|\, (x,y) \in E\}\).
    Siccome \(E_x\) è spesso vuoto (fuori dall'area), definiamo
    \[
        A = \{x\in \realnumbers \,|\, E_x \neq \varnothing\}
    \]
    Quindi
    \begin{align*}
...
\sexercise{}{
    ...
    \begin{align*}
        E_{(x,y)} &= \{z \in \realnumbers \,|\, (x,y,z) \in E^+\} \\
        &= \{z\in\realnumbers \,|\, 0 < z < \sqrt{1 - x - 2y}\}
    \end{align*}
    e
    \begin{align*}
        A =& \{(x,y) \,|\, E_{(x,y)} \neq \varnothing\} \\
...
\sexercise{}{
    ...
    nell'insieme
    \[
        E = \{(x,y,z) \in \realnumbers^3 \,|\, 0<z<x^2 + y^2 <1\}
    \]
...
\sexercise{}{
    ...
    su
    \[
        \Omega = \{(x,y,z) \in \realnumbers^3 \,|\, x^2 + y^2 \leq 1\}
    \]
...
\sexercise{}{
    ...
    \[
        \Omega' = \{(x,y) \in \realnumbers^2 \,|\, 0 < {(x-1)}^2 + {(y-1)}^2 < 2\}
        \subset \Omega \cap \{(x,y) \in \realnumbers^2 \,|\, x>0 \land y>0\}
    \]
...
\sexercise{}{
    ...
    sull'insieme
    \[
        E = \{(x,y) \in \realnumbers^2 \,|\, (x^2 + y^2)z^2 \leq 1 \land y>0 \land z>0 \land y>-x\}
    \]
    Usiamo le coordinate cilindriche
    \[
