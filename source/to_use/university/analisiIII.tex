...
\stheorem{}{
    ...
    Allora
    \[
        \underset{n}{\lim} \int_X f_n\,d\mu = \int_X (\underset{n}{\lim} f_n)\,d\mu
    \]
}
...
\sproof{}{
    Abbiamo
    \[
        f_n \leq f_{n+1} \cdots \leq f, \quad f = \underset{n}{f_n}
    \]
    Quindi
    \[
...
% def di lim inf, lim sup

\sproposition{}{
    \[
        \underline{\lim} \,a_n = \underset{n}{\sup} \, (\underset{k \geq u}{\inf} a_k)
    \]
}
Siccome \[
    b_n = \underset{k \geq u}{\inf} a_k
\]
è monotona crescente, abbiamo allora
\[
    \underline{\lim}\, a_n = \lim_n b_n = \lim_n \left( \underset{k \geq n}{\inf} a_k\right)
\]

\sproposition{Proprietà lim inf e sup}{
    \begin{enumerate}
        \item \[
            \underline{\lim}\, -a_n = - \overline{\lim}\, a_n
        \]
        \item \[
            \underline{\lim}\, (a_n + b) = b + \underline{\lim}\, a_n
        \]
    \end{enumerate}
}
...
\sproof{}{
    Consideriamo
    \[
        g_n = \underset{k\geq n}{\inf}\, f_k
    \]
    chiaramente \(g_n \leq g_{n+1} \to \underline{\lim}\, f_n\) e sono misurabili.
    Consideriamo allora l'integrale
    \begin{align*}
        \lim \int_X g_n \,d\mu = \int_X \underline{\lim} f_n\,d\mu
    \end{align*}
    e per il teorema della convergenza monotona e definizione di lim inf
    \begin{align*}
        \int_X \underline{\lim}\, f_n\,d\mu &= \lim_n \int_X (\underset{k\geq n}{\inf}\, f_k)\,d\mu \\
        &\leq \underline{\lim} \int_X f_n\,d\mu
    \end{align*}
}
...
\sproof{}{
    ...
    \[
        \int_X \underline{\lim}\, (2g - |f-f_n|)\,d\mu \leq \underline{\lim}
        \int_X (2g - |f-f_n|)\,d\mu
    \]
    Ma per le proprietà dei lim inf possiamo estrarre la costante
    \begin{align*}
        \int_X 2g - \lim|f-f_n| &= \int_X 2g \\
        &\leq \underline{\lim} \left( \int_X 2g\,d\mu - \int_X |f-f_n|\,d\mu \right) \\
        &= \int_X 2g \,d\mu - \overline{\lim} \int_X |f-f_n|\,d\mu
    \end{align*}
    Abbiamo quindi
    \begin{align*}
        \int_X 2g\,d\mu &\leq \int_X 2g\,d\mu - \overline{\lim} \int_X |f-f_n|\,d\mu \\
        \overline{\lim} \int_X |f-f_n|\,d\mu &\leq 0
    \end{align*}
