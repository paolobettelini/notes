...
\sproposition{}{
    \[
        \liminf a_n = \underset{n}{\sup} \, (\underset{k \geq u}{\inf} a_k)
    \]
}
Siccome \[
...
\[
    \liminf a_n = \lim_n b_n = \lim_n \left( \underset{k \geq n}{\inf} a_k\right)
\]
...
\sproof{}{
    ...
    \begin{align*}
        \int_X \liminf f_n\,d\mu &= \lim_n \int_X (\underset{k\geq n}{\inf}\, f_k)\,d\mu \\
