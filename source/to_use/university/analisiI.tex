...
\sdefinition{Integrale di Riemann}{
    ...
    \[
        s(f, I) = \sup \left\{
            \int_I \varphi \mid \varphi \text{ a scala e } \varphi \leq f \text{ in } I
        \right\}
    \]
    e superiore
    \[
        S(f, I) = \inf \left\{
            \int_I \varphi \mid \varphi \text{ a scala e } \varphi \geq f \text{ in } I
        \right\}
    \]
    % TODOURGENT
    Ovviamente \(s(f, I) \leq S(f, I)\).
    Diciamo che \(f\) è integrabile nel senso di Riemann se
    \(s(f, I) \leq S(f, I)\). In tal caso, il valore comune è l'\emph{integrale di Riemann}
    \[
...
vale
\[
    \int_I \varphi \leq s(f, I) \leq S(f, I) \leq \int_I \psi
\]
...
\[
    s(1_\mathbb{Q}, [a,b]) = \sup\left\{
        \int_I \varphi \mid \varphi \text{ a scala e } \varphi \leq 1_\mathbb{Q} \text{ in } I
...
\[
    S(1_\mathbb{Q}, I) = \inf\left\{
        \int_I \psi \mid \psi \text{ a scala e } \psi \geq 1_\mathbb{Q} \text{ in } I
...
\sproof{}{
    \begin{enumerate}
        ...
        tale che
        \[
            \int_I \varphi_\varepsilon > s(f, I) - \frac{\varepsilon}{2} = \int_I f - \frac{\varepsilon}{2}
        \]
        e analogamente esiste \(\psi_\varepsilon\) a scala con \(\psi_\varepsilon \geq f\) su \(I\)
        tale che
        \[
            \int_I \psi_\varepsilon < S(f, I) + \frac{\varepsilon}{2} = \int_I f + \frac{\varepsilon}{2}
        \]
        ...
        da cui
        \[
            0 \leq S(f, I) - s(f, I) \leq
            \int_I \psi_n - \int_I \varphi \to 0
        \]
        cosicché \(S(f, I)\) non può che non essere uguale a \(s(f, I)\) e quindi \(f\)
        è integrabile nel senso di Riemann. Inoltre, otteniamo che
        \[
            0 \leq s(f, I) - \int_I \varphi_n = \int_i f - \int_I \varphi_n
...
\sproof{}{
    ...
    \begin{itemize}
        ...
        e
        \begin{align*}
            0 \leq \in_I \psi_\varepsilon - \int_I \varphi_\varepsilon &< \int_I \psi_\varepsilon^f + \int_I \psi_\varepsilon^g - \int_I \varphi_\varepsilon^f - \int_I \varphi_\varepsilon^f - \int_I \varphi_\varepsilon^g \\
            &< \frac{\varepsilon}{2} + \frac{\varepsilon}{2} = \varepsilon
        \end{align*}
...
% usare integrale con trattino sopra o sotto al posto di s() e S()
