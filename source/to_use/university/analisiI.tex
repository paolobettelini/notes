...
Il valore \(n!\) è pari alla cardinalità dell'insieme di tutte le funzini fa \(F_n\) a \(F_n\)
...
in quando non c'è un inverso \(n^{-1}\) (c'è solamente per \(1\) e \(-1\)).
...
Un valore \(m\in X\) si dice \textit{massimo} di \(E\) se \(M\) è un maggiorante e \(m\in E\).
Un valore \(m\in X\) si dice \textit{minimo} di \(E\) se \(M\) è un maggiorante e \(m\in E\).
...
\section{Estremi superiori e inferiori}
...
\sproof{}{
    \begin{itemize}
        ...
        per esempio \(1\).
        \item L'insieme \(E\) è superiormente banalmente limitato superiormente
        ...
        e quindi \(\mu + \frac{1}{n} \in E\) in quando
        \begin{align*}
