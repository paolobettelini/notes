...
\sproposition{Proprietà dei limiti}{
    \begin{enumerate}
        ...
        Quindi se \(n \geq \max\{N_1, N_2\}\), \(x_n \in I \cap J = \emptyset\) .%\ TODOURGENTlightning.
...
\begin{enumerate}
    \item \(x_n + y_n \to \lambda + \mu\) dove \(\lambda + \mu\).
...
% TODOURGENT from: La definizione di limite finito è:
% fino a fine pagina.
