...
\subsection{Simboli di Lanbdau}

\sdefinition{Simboli di Lanbdau}{
    \begin{enumerate}
...
\sproposition{Proprietà dell'asintoto}{
    La relazione dell'asintoto è una relazione di equivalenza nell'insieme delle successioni.
}
