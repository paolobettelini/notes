...
\snote{}{
    La funzione che porta un naturale nella sua fattorizzazione è
    \[
        f\colon \mathbb{N} \to \mathcal{P}(\mathbb{P} \times \mathbb{N}^*)
    \]
    dove \(\mathbb{P}\) è l'insieme dei primi, definita da
    \[
        f(n) = \bigcup_{i\in I} \{(p_i, \alpha_i)\}
    \]
    tale che
    \[
        n=\prod_{i\in I} p_i^{\alpha_i}, \quad i \neq j \implies p_i \neq p_j
    \]
    Per il teorema fondamentale dell'aritmentica, \(f\) è biettiva.
}
