...
\[
    E= \{ n \in \mathbb{N} \suchthat n \geq n_0 \}
\]
...
\begin{itemize}
    \item \textbf{proprietà archimedea:} \(\forall x \in \realnumbers, \forall a > 0, \exists n\in\mathbb{N} \suchthat na>x\) (in realtà vale anche in \(\mathbb{Q}\)).
...
\begin{radioactive}
\[
    E = \left\{ x_n = \frac{1}{n} \suchthat n\in {\mathbb{N}}^* \right\} \cup (2,3) \cup \{4\}
\]
\begin{itemize}
...
Definiamo inoltre \(\sup_{n} x_n = \sup \{ x_n \suchthat x \in \mathbb{N} \}\)
...
\sdefinition{Classe di continuità}{
    ...
    \[
        C^n = \begin{cases}
            ...
            \{ f \colon I \to \realnumbers \suchthat \exists f^{(n)} \text{ in } I \land \forall k \leq n, f^{(n)} \text{ è continua in } I \} & n \in \mathbb{N}^* \\
