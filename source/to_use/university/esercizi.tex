...
\begin{snippetexercise}{Studiare al variare di \(a,b\in\realnumbers\) la derivabilità
    della funzione \[
        f(x) = \begin{cases}
...
\begin{snippetexercise}{Tra tutti i contenitori cilindrici di volume fissato \(V\),
...
\begin{snippetexercise}{}
    Let
    \[
        E = \left\{ x\in\realnumbers \,|\, \frac{1}{2} \leq x < 5 \right\}
    \]
    and the sequence \[
        F = \{ x = x_n \,|\, x_n = \frac{n + 1}{n + 2}, \quad n\in\naturalnumbers^* \}
    \]
    %%%%%%%
...
\begin{snippetexample}{}
    ...
    \[
        ...
        \end{cases}
    \]
    Per ogni \(\alpha\), \(f\) è derivabile in \(\realnumbers \backslash \{0\}\) e \begin{align*}
