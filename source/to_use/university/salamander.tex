...
Come notato nel paper originale, possiamo completare i pallini nei diagramma,
...
\begin{proof}
    ...
    \]
    percorre dunque la direzione \(e_i\) almeno due volte. Per il lemma sulle
    composizioni che ripetono una direzione, otteniamo
    \[
...
Nel caso tridimensionale troviamo quindi il seguente diagramma: \\
\begin{center}
\begin{tikzpicture}[
    >=Latex,
    x=1.1cm, y=0.9cm,
...
Per \(n=2\) ritroviamo banalmente il rombo di Bergman
\begin{center}
