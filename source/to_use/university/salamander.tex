...
Questo paper generalizza il paper di Bergman
a dimensioni di cocomplessi superiori.
...
Il lemma ci dà quindi una successione di mappe della forma \((3,1) \to (2,2) \to (1,3)\).
...
TODO: Dobbiamo assicurarci che questi siano oggetti della forma di Bergman (quindi oltre che siano ben definiti).
...
\begin{lemma}
    ...
    \[
        ...
        \cdots \to
        A_{x + \sum_{j=1}^{n-1} e_{i,j}}
    \]
    induces a chain of morphisms
    \[
        M_1\left(A_{x}\right) \to
        M_2\left(A_{x + e_{i_1}}\right) \to
        M_3\left(A_{x + e_{i_1} + e_{i_2}}\right) \to
        \cdots \to
        M_{n}\left(A_{x + \sum_{j=1}^{n-1} e_{i,j}}\right)
    \]
\end{lemma}
...
Future TODO: the squares of the Boolean diagram commute.
...
\begin{proof}
    ...
    \begin{DispWithArrows*}
        M_r(A) &= \frac{
            ...
            \ker\partial\left[
                ...
                x + \displaystyle\sum_{j=1}^{r-1} e_{i_j} + \displaystyle\sum_{j \in J} e_j
            \right]
        }{
        ...
        &= \frac{
            ...
            \ker\overbrace{
                \partial\left[
                    y,
                    y + \displaystyle\sum_{j \in J} e_j
                \right]
            }^{\partial_{J,n-r+1}}
        }{
            \displaystyle\sum_{\substack{J \subseteq \{1, \cdots, n\} \\ |J| = r}}
    ...
    \begin{DispWithArrows*}
        M_{r+1}(B) &= \frac{
            ...
            \ker\partial\left[
                ...
                x + \displaystyle\sum_{j=1}^{r-} e_{i_j} + \displaystyle\sum_{j \in J} e_j
            \right]
        }{
        ...
        &= \frac{
            ...
            \ker\overbrace{
                \partial\left[
                    y + e_{i_r},
                    y + e_{i_r} + \displaystyle\sum_{j \in J} e_j
                \right]
            }^{\partial_{J,n-r}}
        }{
            \displaystyle\sum_{\substack{J \subseteq \{1, \cdots, n\} \\ |J| = r+1}}
    ...
    \(K = \bigcap \ker\partial_{J, n-r+1}\)
    in \(M = \bigcap \ker\partial_{J, n-r}\)
    e \(H = \sum \im\partial_{J, r}\)
    in \(N = \sum \im\partial_{J, r+1}\).
    \begin{itemize}
        \item \(f\) manda \(K\) in \(M\): consideriamo un morfismo \(\partial_{J, n-r}\)
        arbitrario della definizione di \(M\) e mostriamo che esiste sempre
        un morfismo della definizione di \(K\) tale per cui \(f\) si restringe
        fra questi due.
        ...
        scelto dalla definizione di \(M\), e distinguiamo due casi:
        \begin{itemize}
            \item se \(e_{i_r} \in \#\partial_{J,n-r}\), allora \((\partial_{J,n-r} \circ f)\) traversa
            due volte la direzione \(e_{i_r}\). Per commutatività del complesso, possiamo scegliere
            una rappresentazione di \((\partial_{J,n-r} \circ f)\) tale per cui i primi due morfismi
            nella composizione traversano la direzione \((e_{i_r})\). Ma quindi, per definizione di cocomplesso,
            abbiamo che \(\partial_{J,n-r} \circ f = 0\) sempre.
            \item se \(e_{i_r} \notin \#\partial_{J,n-r}\), allora \((\partial_{J,n-r} \circ f)\) traversa
            solo una volta la direzione \(e_{i_r}\).
            Nella definizione di \(K\) vengono usati tutti i morfismi partenti da \(A\) di lunghezza
            ...
            \(\partial \iota = \partial_{J,n-r} f \iota = 0\). XXX
        \end{itemize}
        \item \(f\) manda \(H\) in \(N\): Omessa per ora ma stessa forma.
    \end{itemize}
    XXX
\end{proof}
