...
\begin{definition}
    The \emph{\(3\)-middle object} centered at \(x\) is defined as
    \[
        M(x) \triangleq \frac{
            \displaystyle\bigcap_{\substack{i,j=1 \\ i \neq j}}^{3}
            \ker \partial[x, x + e_i + e_j]
        }{
            \displaystyle\sum_{\substack{i,j=1 \\ i \neq j}}^{3}
            \im \partial[x-e_i - e_j, x]
        }
        = XXXXX
    \]
\end{definition}
...
O più in generale
\begin{definition}
    The \emph{\(n\)-middle object} centered at \(x\) is defined as
    \[
        M(x) \triangleq \frac{
            \displaystyle\bigcap_{\substack{k_1=1, \cdots, k_{n-1}=1 \\ k_1 \neq \cdots \neq k_{n-1}}}^{n}
            \ker \partial\left[x, x +  \sum_{j=1}^{n-1} e_{k_j}\right]
        }{
            \displaystyle\sum_{\substack{k_1=1, \cdots, k_{n-1}=1 \\ k_1 \neq \cdots \neq k_{n-1}}}^{n}
            \im \partial\left[x- \sum_{j=1}^{n-1} e_{k_j}, x\right]
        }
        = XXXXX
    \]
\end{definition}
