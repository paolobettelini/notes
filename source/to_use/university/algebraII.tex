...
\begin{snippetproof}{First isomorphism theorem}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            \} \\
            &= \{v + \text{ker}_\varphi \suchthat v \in \text{ker}_\varphi\} \\
...
Sia \(A = \mathbb{Z}\) e \(I = (n) = \{n \cdot k \suchthat k \in \mathbb{Z}\}\).
...
\begin{snippetproof}{}
    ...
    \begin{align*}
        \text{ker}(\varphi) &= \{
            a \in A \suchthat \varphi(a) = 0_{\oplus A/I_i} = (0_{A/I_1}, \cdots, 0_{A/I_r})
        \} \\
        &= \{
    ...
    \end{align*}
    We now show that it is surjective. We need to show that \(\forall i\), there exists \(a_i \in A\)
    such that
    \begin{align*}
    ...
    \begin{align*}
        \pi_i(b) = b+I_i &\implies (0_A + I_1, \cdots, b + I_i, \cdots, 0_A + I_r) \\
    ...
    Note that \(I_i\) and \(\bigcap_{i\neq j} I_j\) are coprimi, meaning \(\exists x_i \in I_i\)
    ...
    \end{align*}
    e quindi \(a_i = y_i\).
    Quindi un generico elemento della somma diretta pu?o essere scritto come immagine di questo.
\end{snippetproof}
