...
\sdefinition{}{
    ...
    Denotiamo \(x_h\) e \(y_k\) le coordinate dei rettangoli delel rispettive variabili, quindi
...
\[
    f(x,y) = \begin{cases}
        1 & x,y \in \mathbb{Q} \intersection [0,1] \\
        0 & \text{otherwise}
    \end{cases}
\]
...
\sexample{}{
    Sia \[
        Z = \{(x,y) \in [0,1] \times [0,1] \suchthat x,y \in \mathbb{Q}\}
    \]
...
\sexample{}{
    Sia \(D = (\mathbb{Q} \intersection [0,1])^2 \subseteq [0,1] \times [0,1]\).
...
\sexample{}{
    ...
    \begin{align*}
        \iiint_D f(x,y,z) \,\text{d}x\,\text{d}y\,\text{d}z
        &=
        \iint_T \integral[0][1-x-y][f(x,y,z)][z] \,\text{d}x\,\text{d}y
    \end{align*}
