...
\sexercise{}{
    ...
    \begin{align*}
        J_{(x,y)}F(0,0,0,0) = \begin{pmatrix}
            2 & 0 \\ -3 & 3
        \end{pmatrix}, \quad J_{(s,t)}F(0,0,0,0) = \begin{pmatrix}
            2 & -1 \\ 1 & 1
        \end{pmatrix}
    \end{align*}
    E l'inverso è dato da
    \begin{align*}
        J_{(s,t)}F(0,0,0,0)^{-1} = \frac{1}{3} \begin{pmatrix}1 & 1 \\ -1 & 2\end{pmatrix}
    \end{align*}
...
\sexample{}{
    ...
    Sia \(k = m-n\) la dimensione di \(\Phi^{-1}(0)\) (se tutto va bene)
    come varietà.
}
