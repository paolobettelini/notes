...
\begin{snippetexercise}{Problema del biliardo I}
    ...
    Suggerimento: nel biliardo sviluppato per riflessione,
    parametrizzare la traiettoria con
    \[
        x(t)=nat+x_0,
        \qquad
        y(t)=mbt+y_0,
...
\begin{snippetexercise}{Problema del biliardo II}
    ...
    se \(\mu\) è irrazionale rispetto a \(\frac{b}{a}\), cioè
    \[
        \frac{\mu}{b/a}\notin\rationalnumbers,
    \]
    allora la traiettoria è densa nel biliardo.

    Suggerimento: è sufficiente studiare il modello sviluppato e usare
    la discussione sulle orbite modulo un reticolo. In particolare, si
    riconduca il problema ai due enunciati finali della discussione
    vista a lezione.
\end{snippetexercise}
...
\begin{snippetexercise}{Folium di Cartesio}
    ...
    senso essa si autointerseca all'infinito.
...
\begin{snippetexercise}{Metrica su sottoinsiemi connessi da archi rettificabili}
    ...
    Suggerimento: usare la proposizione sulla lunghezza di curve
    \(C^1\) a tratti vista nella Lezione 4.
\end{snippetexercise}
...
\begin{snippetexercise}{Distanze su cono circolare}
    ...
    quelli in cui è realizzata dal cammino spezzato \(\tau\).

    Suggerimento: sviluppare il cono sul piano e confrontare la
    lunghezza dell'arco di parallelo con la lunghezza del cammino
    passante per il vertice. Nel caso limite compare l'equazione
    \[
        \pi\sin\theta = 2.
    \]
\end{snippetexercise}
...
\begin{snippetexercise}{Esistenza dell'inviluppo}
    ...
    non è costante se e solo se \(F\) non esprime un fascio di rette.
...
\begin{snippetexercise}{Proprietà focale delle coniche}
    Dimostrare la proprietà focale dell'ellisse: se \(F_1\) e \(F_2\)
    sono i fuochi di un'ellisse e \(P\) è un punto dell'ellisse, allora
    la retta tangente in \(P\) forma angoli uguali con le rette
    \(PF_1\) e \(PF_2\).
...
\begin{snippetexercise}{Embedding di \(\mathbb{P}^2_{\realnumbers}\)
    in \(\realnumbers^4\)}
...
\begin{snippetexercise}{Mappa antipodale e riflessione rispetto a un
    piano equatoriale}
    Sia
    \[
...
\begin{snippetexercise}{Transitività di
...
\begin{snippetexercise}{Somma degli angoli interni di un triangolo
...
\begin{snippetexercise}{Somma degli angoli interni di un triangolo in
    geometria sferica}
    Mostrare che la somma degli angoli interni di un triangolo a lati
