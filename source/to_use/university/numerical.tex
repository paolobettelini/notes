...
\section{Errore inerenti nei processi di soluzione di sistemi lineari}
...
\subsection{Contesto più generale}
...
\begin{snippetproof}{}
    ...
    \begin{align*}
        ||AB||_a &= \sup_{y\neq 0} \frac{||AB_y||_b}{||y||_b}
        \leq \sup_{y\neq 0} \frac{||A||_a} \cdot \frac{||B_y||_b}{||y||_y} \\
...
\begin{snippetexercise}{}
    ...
    calcolare
    \[
        \sup_{||f||_\infty \leq 1} ||A(f)(x)||_\infty = \int_D |K|
    \]
\end{snippetexercise}
