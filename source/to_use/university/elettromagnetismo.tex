...
Dove $\omega$ è una $k$-forma differenziale e $d\omega$ è la sua derivata esterna (una $(k+1)$-forma). Vediamo come si riduce ai due casi fondamentali dell'elettromagnetismo in $\mathbb{R}^3$.
...
\begin{itemize}
    ...
    \item \textbf{La 2-forma $d\omega$:} La derivata esterna di una 1-forma in $\mathbb{R}^3$ corrisponde al rotore del campo:
...
\begin{itemize}
    ...
    \item \textbf{La 3-forma $d\omega$:} La derivata esterna di una 2-forma in $\mathbb{R}^3$ corrisponde alla divergenza del campo moltiplicata per l'elemento di volume:
