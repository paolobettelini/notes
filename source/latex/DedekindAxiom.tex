...
\begin{snippetproof}{dedekind-completness-axiom-equivalence-theorem-proof}{dedekind-completness-axiom-equivalence-theorem}{Dedekind and completness axioms equivalence}
    \begin{iffproof}
        \item Let \(E\) be a non-empty \set that is \upperbound[bounded above]. We will prove that there exists \(c=\sup E\).
        ...
        By the axiom of continuity, there exists \(\exists c\in \realnumbers\) such that
        \[
            \bigcap_{n\in\naturalnumbers} I_n = \{c\}
        \]
        ...
        \item Let \(I_n = [a_n, b_n]\) be a \sequence of closed intervals and bounded such that
        \[
            I_{n+1} \subseteq I_n
        \]
        ...
        Thus:
        \begin{itemize}
            \item the \sequence \(a_n\) is increasing and \upperbound[bounded above],
                thus \(a_n \to c^-\);
            \item the \sequence \(b_n\) is decreasing e \lowerbound[bounded below],
