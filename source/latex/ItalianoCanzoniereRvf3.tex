...
\begin{snippet}{canzoniere-rvf-3}
    ...
    \StellarPoetry{1}{
        ...
        Era Venerdì Santo, giorno della passione e morte di Cristo, durante il quale la luce dei raggi del sole sbiadì
        \bfslash per la compassione che essi hanno nei confronti del loro Creatore [incarnato e crocifisso];
        \bfslash quando io fui conquistato dall'amore, e non pensai a difendermi [da quell'incanto],
        \bfslash perché i tuoi begli occhi, Laura, mi legarono indissolubilmente a te.
    }
    \StellarPoetry{5}{
        ...
        (Essendo un giorno di lutto e meditazione religiosa) non mi pareva quello il momento di difendermi
        \bfslash dall'attacco improvviso di Amore; perciò andavo
        \bfslash fiducioso e senza timori: ragion per cui il mio dolore interiore e personale
        \bfslash ebbero inizio in mezzo al dolore generale per la Passione di Cristo (\quotes{commune dolor}).
    }
    \StellarPoetry{9}{
        ...
        \bfslash e trovò libero il cammino per entrare nel cuore attraverso gli occhi,
        \bfslash che da quel momento sono diventati una sorgente da cui sgorgano lacrime.
    }
    \StellarPoetry{12}{
        ...
        \bfslash colpire con la freccia me, che ero in quello stato inerme [di pietà e contemplazione religiosa],
        \bfslash e non mostrare neppure l'arco a te, Laura, che eri ben difesa (dalla tua virtù e castità).
    }
