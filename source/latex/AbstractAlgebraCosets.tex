...
\plain{If we had defined the cosets on a monoid, a partition would not necessarily
...
\plain{The only coset containing the identity is the subgroup itself, meaning that it is also the only coset that is a subgroup.}
...
\plain{In the infinite case we can still say tha that the cardinality of the right cosets
...
\plain{This also means that an infinite group can have finite cosets.}
