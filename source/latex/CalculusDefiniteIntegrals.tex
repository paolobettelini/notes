...
\begin{plainhtml}
    The induced partition is the minimal partition that can be used to represent a step function.
\end{plainhtml}
...
\begin{snippetproof}{integral-mean-value-theorem-proof}{integral-mean-value-theorem}{Mean Value Theorem}
    \begin{enumerate}
        ...
        and for every \(x\in [a,b]\) we have that
        \[
        ...
        \[
            f(c) = \frac{1}{b-a} \integral[a][b][f(t)][t]
        \]
    \end{enumerate}
\end{snippetproof}
