...
\begin{snippetproposition}{metric-topology-open-classification}{}
    ...
    \begin{enumerate}
        ...
        \item the \openset[open sets] of \(\mathcal{T}_d\)
...
\begin{snippetproof}{metric-topology-open-classification-proof}{metric-topology-open-classification}{}
    \begin{enumerate}
        ...
        \item We know that every \openball is \openset[open]
        in \(\mathcal{T}_d\). Viceversa, let \(A\) be an \openset
...
\begin{plainhtml}
    This clearly shows that we lose the quantitative aspects of a metric space when inducing a topological space,
    but the qualitative aspects are preserved.
\end{plainhtml}

\begin{plainhtml}
    All the metrics induced by the p-norms induce the same topology.
\end{plainhtml}
