...
\begin{snippetdefinition}{topological-presheaf-definition}{Presheaf}[\generalizations{presheaf-definition}]
...
\begin{snippetdefinition}{topological-sheaf-definition}{Sheaf}[\generalizations{sheaf-definition}]
    Let \(X\) be a \topologicalspace.
