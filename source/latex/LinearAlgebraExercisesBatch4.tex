...
\begin{snippetsolution}{linear-algebra-batch-4-ex-4-sol}{}
    \begin{enumerate}
        ...
        but \(U_1 \neq U_2\).
        \item Let \(U = \linearspan((1,0))\), \(V = \linearspan((1,1))\) and \(W = \linearspan((-1,1))\). Then, \(\realnumbers^2 = U \oplus V = U \oplus W = V \oplus W\).
    \end{enumerate}
...
\begin{snippetsolution}{linear-algebra-batch-4-ex-5-sol}{}
    ...
    \[
        ...
        \end{pmatrix}
    \]
    and thus the system has infinite solutions if \(t = \frac{80}{7}\).
\end{snippetsolution}
...
\begin{snippetexercise}{linear-algebra-batch-4-ex-8}{}
    ...
    \[
        U = \{(x,y,z,w) \in \realnumbers^4 \suchthat 2x + y + z = 0 \land z + w = 0\}
    \]
    \begin{enumerate}
