...
\includesnpt{biennio-rosso-definition}
...
\begin{plainhtml}
    I comunicati ufficiali dell'MinCulPop erano chiamati le veline. Essi fornivano direttive precise per i media
\end{plainhtml}
...
\begin{plainhtml}
    L'azienda venne riaperta con la denominazione di Rai (Radio Audizioni Italiane) e nel 1954 come Radiotelevisione Italiana.
\end{plainhtml}
...
% uso della forza. Controllo dell'economia.
% fascismo è un (quasi) totalitarismo perché è costreto a concigliarsi con le istituzioni del potere tradizionale (la chiesa, patti lateralensi, ma anche il Re e la monarchia. Il sovrano, seppur discutibile, rimane tale Vittorio Emanuele III)
