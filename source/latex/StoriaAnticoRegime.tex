...
\begin{snippetdefinition}{antico-regime-definizione}{Antico regime}
...
\begin{snippetdefinition}{monarchia-definizione}{Monarchia}
...
\begin{snippetdefinition}{repubblica-definizione}{Repubblica}
...
\begin{snippetdefinition}{impero-definizione}{Impero}
...
\begin{snippetdefinition}{feudo-definizione}{Feudo}
    Grossa proprietà terriera.
\end{snippetdefinition}

\begin{snippetdefinition}{monarchia-feudale-definizione}{Monarhia feudale}
...
\begin{snippetdefinition}{stato-definizione}{Stato}
...
\begin{snippetdefinition}{stato-moderno-definizione}{Stato moderno}
...
\begin{snippetdefinition}{bill-of-rights-definizione}{Bill of Rights}
...
\begin{snippetdefinition}{Illuminismo-definizione}{Illuminismo}
...
\begin{snippetdefinition}{giusnaturalismo-definizione}{Giusnaturalismo}
...
\begin{snippetdefinition}{dispotismo-illuminato-definizione}{Dispotismo illuminato}
