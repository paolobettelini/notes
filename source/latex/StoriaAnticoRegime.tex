...
\begin{snippet}{antico-regime-caratteristiche}
    ...
    componenti di diverse epoche, anche di millenni di anni, ancora rigorosamente in vigore.
\end{snippet}
...
\begin{snippet}{4eaa8b47-e9bd-45f7-b37d-e018de488593}
    Un uomo detiene quindi la sovranità, affidatagli generalmente da una divinità
...
\begin{snippet}{monarchia-feudale-potere-limitato}
    ...
    \begin{itemize}
        ...
        \item l'amministrazione del terrotorio e della giustizia è delegata ai signori, nobili feudatari, vassalli del re;
        \item il clero (la Chiesa) amministra le proprie terre;
        \item i comuni con status particolari (non sono sotto diretto potere del sovrano).
    \end{itemize}
\end{snippet}
...
\begin{snippet}{f50405ec-b1b2-4853-b4a1-daf0d353a681}
    ...
    Il primogenito di una famiglia nobiliare eredita spesso le varie terre, mentre il secondogenito
...
\begin{snippet}{25a8c8db-0800-465b-a2b8-8193b1ea6050}
    \vspace{-0.25cm}
    \begin{itemize}
        \item Il potere limitato dal re;
        \item un parlamento rappresentativo dotato del monopolio legislativo;
        \item sistema giudiziario a garanzia dell'integrità delle persone e di alcuni diritti individuali
    \end{itemize}
    ...
    Seppur limitato, il potere del sovrano viene esercitato in modo uniforme su tutti i sudditi e su tutto il territorio.
    
    Il potere statale non è più concentrato, bensì ripartito tra figure diverse:
    \begin{itemize}
...
\begin{snippet}{illuminismo-caratteristiche-expl}
    ...
    Un movimento cosmopolita (La Natura, Il Cosmo sono gli stessi ovunque si metta piede. Perciò essi
    ...
    Inoltre, era caratterizzato dalla tolleranza; libertà di coscienza e di opinione.
\end{snippet}

% TODO def intolleranza. di alberto pincherie Encliclopedia italiana 1933

\plain{Possiamo cominciare a parlare di tolleranza quando vi sono molteplici religioni o teismi che sostengono di possedere la verità assoluta, le quali vanno in conflitto diretto con le altre.}
...
\begin{snippet}{03357b7f-ad6e-4633-81a4-7d336aca5686}
    ...
    e \textbf{indipendenti} in maniera tale che essi si bilancino e si frenino a vicenda.
\end{snippet}
...
\plain{Voltaire porta avanti il concetto di dispotismo assolutismo ma illuminato (intellettuali illuministi, consiglieri).
...
\begin{snippet}{e27006e5-5af6-4257-9405-c403ca5eb376}
    ...
    \begin{itemize}
        ...
        \item nel contratto sociale Rousseau ipotizza un patto in cui gli uomini non perdono mai la libertà né la sovranità: questo patto è chiamato \textit{contratto sociale} e fonda la democrazia.
