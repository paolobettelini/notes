...
\begin{snippetdefinition}{set-category-definition}{\(\mathbf{Set}\)}
    ...
    \begin{enumerate}
        ...
        \item \(\forall (X,\tau_X),(Y,\tau_Y)  \in \catob(\mathbf{Top}), \cathom_\mathbf{Top}((X,\tau_X),(Y,\tau_Y))\)
...
\begin{snippetproof}{category-set-monomorphism-proof}{category-set-monomorphism}{Monomorphisms in \textbf{Set}}
    \begin{iffproof}
        \item Suppose that \(f \colon A \fromto B\) is a \monomorphism.
        ...
        \item Assume that \(f \colon A \fromto B\) is \injective.
...
\begin{snippetproof}{category-set-epimorphism-proof}{category-set-epimorphism}{Epimorphisms in \textbf{Set}}
    \begin{iffproof}
        \item Suppose that \(f \colon A \fromto B\) is an \epimorphism,
        ...
        \item Let \(f\colon A \fromto B\) be \surjective.
