...
\begin{snippetsolution}{linear-algebra-batch-1-ex-1-sol}{}
    ...
    Otherwise, we have
    \[
        r_k = \left\{(x,y) \in \realnumbers^2 \suchthat y = -\frac{x}{k} + \frac{1}{k}\right\}
        \qquad
...
\begin{snippetsolution}{linear-algebra-batch-1-ex-2-sol}{}
    \begin{itemize}
        ...
        \]
        \item \((1) \implies (3):\) if \((b, \beta) \neq (0,0)\), then
        we can let \(u = \beta\) and \(v = -b\). Otherwise,
        if \(a \neq 0\), we can let \(u = \frac{-v\alpha}{a}\) and \(v \in \realnumbers^\exceptzero\).
        Otherwise, we can let \(u \in \realnumbers^\exceptzero\) and \(v = 0\).
        \item \((3) \implies (1):\) if \(u \neq 0\), we have
        \[
            a = \frac{-v\alpha}{u}
            \qquad
            b = \frac{-v\beta}{u}
        \]
        meaning that \[
            \Delta = a\beta - b\alpha = \frac{-v\alpha\beta}{u} - \left(-\frac{v\alpha\beta}{u}\right) = 0
        \]
        If \(v \neq 0\) we have
        \[
            \alpha = \frac{-ua}{v}
        ...
        meaning that
        \[
            \Delta = a\beta - b\alpha = \frac{-uab}{v} - \left(-\frac{uab}{v}\right) = 0
        \]
    \end{itemize}
\end{snippetsolution}
