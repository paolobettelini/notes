...
\begin{plainhtml}
    Le componenti di un miscuglio eterogeneo possono essere separate con metodi meccanici:
\end{plainhtml}
...
\begin{plainhtml}
    Le componenti di un miscuglio omogeneo (soluzioni) possono essere separate con metodi fisici:
\end{plainhtml}
...
\begin{plainhtml}
    Le componenti di una soluzione possono essere separate con metodi chimici:
\end{plainhtml}
