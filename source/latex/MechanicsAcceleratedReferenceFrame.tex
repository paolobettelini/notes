...
\begin{plainhtml}
    We want to study the relation between the observations of two distinct observers.
\end{plainhtml}
...
\begin{plainhtml}
    This means that the axis are precessing around the given (non-constant) vector.
\end{plainhtml}
