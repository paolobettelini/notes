...
\begin{plainhtml}
    if you consider a simple real function, we want the sets on the y axis to be measurable,
\end{plainhtml}
\begin{plainhtml}
    as well as those on the x axis. Thus, the preimage of the x values must be measurable.
\end{plainhtml}
