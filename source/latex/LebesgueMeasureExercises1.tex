...
\begin{snippetsolution}{lebesgue-measure-ex-3-sol}{}
    ...
    Since
    \[
        \sum_{k=1}^{+\infty}\frac{1}{k^{\sfrac32}}<+\infty,
    \]
    it follows that
    \[
        f_n\in\mathcal L^1(\realnumbers)
    \]
    for every \(n\geq 3\).
    ...
    \[
        f_n(x)\to 0,
    \]
    because \(|\sin(x^2)|^{\sfrac1n}\to 1\) and
    \[
        1+x^2+n^2\to+\infty.
    \]
    ...
    Since
    \[
        \sum_{n=3}^{+\infty}\frac{1}{\sqrt{1+n^2}}
        =
        +\infty,
    \]
    ...
    \[
        \frac{t^{-\sfrac14}}{1+t}
    \]
    is bounded by \(Ck^{-\sfrac54}\), while
    \[
    ...
    Since
    \[
        \sum_{k=1}^{+\infty}\frac{1}{k^{\sfrac54}}<+\infty,
    \]
