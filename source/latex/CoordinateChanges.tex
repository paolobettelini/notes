...
\begin{plainhtml}
    Coordinate transformations using affine maps are diffeomorphisms. However, not all transformations, such as polar coordinates, are affine. These transformations must be one-to-one.
\end{plainhtml}
