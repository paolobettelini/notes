...
\begin{plainhtml}
    Tutte le sostanze anfiprotiche sono anfotere, ma non viceversa.
    L'acqua è anfotera
\end{plainhtml}

\begin{plainhtml}
    Costanti acide. Costanti di ionizzazione di acidi e basi deboli.
...
\begin{plainhtml}
    La conducibilità elettrica è una misura
