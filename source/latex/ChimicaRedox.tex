...
\begin{snippetdefinition}{redox-definizione}{Reazione di ossidoriduzione}
...
\begin{snippetdefinition}{numero-ossidazione-definizione}{Numero di ossidazione}
...
\begin{snippetdefinition}{reazione-spontanea-definizione}{Reazione spontanea}
    Una reazione è \textit{spontanea} se procede spontaneamente.
\end{snippetdefinition}

\section{Semireazioni}

\begin{snippetdefinition}{semireazioni-definizione}{Semireazioni}
