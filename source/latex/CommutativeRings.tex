...
\begin{plainhtml}
    Given a domain of integrity we want to find the smallest field containing it.
\end{plainhtml}
...
\begin{plainhtml}
    The domain of integrity can be seen as a subgroup of the quotient field.
\end{plainhtml}
...
\begin{plainhtml}
    There could be multiple distinct maximal ideals.
\end{plainhtml}
