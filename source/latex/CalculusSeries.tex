...
\begin{plainhtml}
    Note that this is a bit of abuse of notation; the same symbol represents both the sequence of partial sums
    and its limit.
\end{plainhtml}
...
\begin{plainhtml}
    This means that modifying a finte amount of terms, does not alter the behavior of the series.
\end{plainhtml}
...
\begin{plainhtml}
    A series where the terms are eventually non-negative cannot oscillate.
\end{plainhtml}
