...
\begin{snippet}{canzoniere-rvf-90-parte1}
    ...
    \StellarPoetry{1}{
        ...
        \parbox[t]{0.4\textwidth}{I biondi capelli come l’oro (di Laura) erano sparsi al vento,
        \textbf{/}che li avvolgeva in tanti dolci giri,
        \textbf{/}e la bella luce di quegli occhi, che ora sono così privi di luminosità, splendeva straordinariamente;}
    }
    \StellarPoetry{5}{
        ...
        \parbox[t]{0.4\textwidth}{e il viso mi sembrava (v. 6: \quotes{mi parea}) assumere un’espressione di benevolenza nei miei confronti
        \textbf{/}Ma non posso dire con certezza se ciò fosse vero o falso:
        \textbf{/}io che avevo confitta nel petto il dardo dell’amore,
        \textbf{/}cosa c’è da stupirsi se subito arsi d’amore?}
    }
    \StellarPoetry{9}{
        ...
        \parbox[t]{0.4\textwidth}{Il suo incedere non era quello di un corpo mortale,
        \textbf{/}ma di uno spirito angelico, e la sua voce
        \textbf{/}aveva un suono diverso da una soltanto (pur) umana;}
    }
    \StellarPoetry{12}{
        ...
        \parbox[t]{0.4\textwidth}{una creatura del cielo, un sole vivente
        \textbf{/}fu quello che vidi; e anche nel caso in cui non avesse più quell’aspetto,
        \textbf{/}di certo la ferita procurata da una freccia non si risana solo perché la corda dell’arco, dopo il colpo sferrato, si allenta.}
    }
\end{snippet}
