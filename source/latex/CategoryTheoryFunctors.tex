...
\begin{plainhtml}
    The construction satisfies the properties of a functor (using function composition associativity).
\end{plainhtml}

\begin{plainhtml}
    The dual can also be considered, where the morphisms go into the object instead of out of it.
\end{plainhtml}
...
\begin{plainhtml}
    We can also define a notion of surjectivity for objects.
