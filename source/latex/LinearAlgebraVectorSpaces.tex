...
\begin{snippetproof}{linear-subspace-criterion-theorem-proof}{linear-subspace-criterion-theorem}{}
    \begin{iffproof}
        \item If \(U\) is a linear subspace, then the properties are satisfied by definition.
        \item By the listed properties, we have:
        \begin{enumerate}
...
\begin{snippetproof}{vector-space-direct-sum-identity-proof}{vector-space-direct-sum-identity}{}
    \begin{iffproof}
        \item Given by the definition of direct sum.
        \item Let \(v \in V\) and consider the representations \(v = v_1 + \cdots v_n\)
...
\begin{snippetproof}{vector-space-sum-is-direct-iff-intersection-is-trivial-proof}{vector-space-sum-is-direct-iff-intersection-is-trivial}{}
    \begin{iffproof}
        \item Let \(v \in U \intersection W\). Consider the representation \(0 = v + (-v)\)
        where \(v\in U\) and \(-v \in W\). Since the sum is direct, \(v = -v\) meaning \(v = 0_V\).
        \item We need to show that the only representation of \(0_V\) is the trivial one.
...
\begin{snippetproof}{vector-space-basis-criterion-proof}{vector-space-basis-criterion}{}
    \begin{iffproof}
        \item Since \(\mathcal{B}\) generates \(V\),
        let \[
        ...
        \item Since every element can be written as a linear combination,
        \[
