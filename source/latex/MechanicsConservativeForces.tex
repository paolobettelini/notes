...
\begin{plainhtml}
    Not all positional forces are conservative; the gradient condition must be satisfied.
\end{plainhtml}
...
\begin{plainhtml}
    By putting together this theorem and the work-energy theorem, we get the mechanical energy conservation.
\end{plainhtml}
