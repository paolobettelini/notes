...
\begin{plainhtml}
    The intersection of infinitely many open sets is not necessarily open, but their union is.
\end{plainhtml}
...
\begin{plainhtml}
    The union of infinitely many closed sets is not necessarily closed, but their intersection is.
\end{plainhtml}
...
\begin{plainhtml}
    The singletons of every element form a basis for this topology.
\end{plainhtml}
...
\begin{plainhtml}
    This topology has the same open sets of the Euclidea topology and more (like the semiopen intervals).
\end{plainhtml}
