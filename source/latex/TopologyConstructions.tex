...
\begin{plainhtml}
    We first glue two sides and make a cylinder, but then because of the inverted orientation, the cylinder must pass through itself to be glued to the other side.
\end{plainhtml}
