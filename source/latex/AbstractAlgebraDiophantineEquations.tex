...
\begin{snippetproof}{linear-diophantine-equation-solvability-proof}{linear-diophantine-equation-solvability}{Linear diophantine equation solvability}
    \begin{iffproof}
        \item For any solution \(u_1, u_2, \cdots, u_n\) to the equation that we plug in,
        ...
        \item If \(\gcd(x_1, x_2, \cdots, x_n) \divides b\), that is \(b = c\gcd(x_1, x_2, \cdots, x_n)\)
...
\begin{plainhtml}
    If there exist solutions, we can show that there actually exist an infinite amount
