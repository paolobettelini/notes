...
\begin{plainhtml}
    Note that the upper bound can be outside of the subset.
\end{plainhtml}
...
\begin{plainhtml}
    Greatest and least elements are upper and lower bounds in the subset.
\end{plainhtml}
...
\begin{plainhtml}
    This is trivial by the anti-symmetric property.
\end{plainhtml}
...
\begin{plainhtml}
    A maximal element is an element such that no other element is strictly greater than it.
\end{plainhtml}
...
\begin{plainhtml}
    Every greatest/least element is a maximal/minimal element.
\end{plainhtml}
