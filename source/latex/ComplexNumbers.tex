...
\begin{snippetdefinition}{complex-numbers-definition}{Complex numbers}
    \textit{Complex numbers}, denoted \(\complexnumbers\), contains numbers in the form \(a + bi\),
    where \(a,b\in\realnumbers\) and \(i\) is the \textit{imaginary unit}, which is defined
    as \(i^2=-1\).
\end{snippetdefinition}
