...
\begin{snippetdefinition}{imaginary-unit}{Imaginary unit}
...
\begin{snippetdefinition}{imaginary-unit-multiplicative-inverse}{Imaginary unit multiplicative}
    The multiplicative inverse of \(i\) is \(-i\).
\end{snippetdefinition}

\begin{snippetproof}{imaginary-unit-multiplicative-proof}{Imaginary unit multiplicative}
    \[
...
\begin{snippetdefinition}{complex-number-definition}{Complex Number}
    Complex numbers are numbers in the form \(a + bi\),
    where \(a,b\in\mathbb{R}\) and \(i\) is the imaginary unit.
\end{snippetdefinition}

\begin{snippetdefinition}{complex-number-set-definition}{Set of complex numbers}
...
\begin{snippetproof}{real-numbers-are-complex-proof}{Real numbers are complex}
...
\begin{snippetdefinition}{complex-real-part-operator}{Real Part}
...
\begin{snippetdefinition}{complex-imaginary-part-operator}{Imaginary Part}
