...
\begin{snippettheorem}{dini-theorem}{Implicit function theorem (Dini)}[\generalizations{general-implicit-function-theorem}]
...
\begin{plainhtml}
    This is a local statement since we need to find sufficiently small radii.
\end{plainhtml}
...
\begin{plainhtml}
    From this formula, it follows that the implicit function has the same regularity as F.
\end{plainhtml}
