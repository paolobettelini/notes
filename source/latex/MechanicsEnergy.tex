...
\begin{plainhtml}
    The path of the force is independent.
\end{plainhtml}
...
\begin{plainhtml}
    Constraint forces are always orthogonal to the movement, so they never do work.
\end{plainhtml}
...
\begin{plainhtml}
    We will now derive the equation of a pendulum using the conservation of energy.
\end{plainhtml}
