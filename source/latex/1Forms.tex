...
\begin{snippetdefinition}{1-form-rn-definition}{\(1\)-form}[\generalizations{1-form-definition}]
...
\begin{plainhtml}
    Analogously, we say that a vector field is conservative if it is the gradient of some function.
\end{plainhtml}
