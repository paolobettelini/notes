...
\begin{snippetproof}{invertible-function-bijective-theorem-proof}{invertible-function-bijective-theorem}{Invertibility \(\iff\) bijectivity}
    \begin{iffproof}
        \item TODO%Sia \(f\) invertibile. Allora sappiamo che \(f(f^{-1})\) è la funzione identità di \(A\) e \(f^{-1}(f)\)
...
\begin{plainhtml}
    The same does not work in general for the image. Only for the union.
\end{plainhtml}
