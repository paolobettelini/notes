...
\begin{plainhtml}
    This means that the curve can only intersect at the ends.
\end{plainhtml}
...
\begin{plainhtml}
    This means that all the components are diferentiable and with a continuous derivative,
...
\begin{plainhtml}
    This is an approximation of the curve of the first order.
\end{plainhtml}
