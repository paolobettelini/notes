...
\begin{snippetcorollary}{subseteq-transitivity}{Subset transitivity}
    ...
    \begin{align*}
        ...
        &2. \quad A \subset B \land B \subseteq C \implies A \subseteq C \\
        &3. \quad A \subseteq B \land B \subset C \implies A \subseteq C \\
        &4. \quad A \subset B \land B \subset C \implies A \subseteq C
    \end{align*}
\end{snippetcorollary}
