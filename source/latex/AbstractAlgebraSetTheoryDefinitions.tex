...
\begin{snippetdefinition}{cartesian-product-two-sets-definition}{Cartesian Product of two sets}[\generalizations{cartesian-product-definition}]
...
\begin{snippetdefinition}{cartesian-product-definition}{Cartesian Product}[\generalizations{category-product-definition}]
...
\begin{snippetdefinition}{disjoint-union-definition}{Disjoint union}[\generalizations{category-coproduct-definition}]
    Given \set[sets] \(A_{i\in I}\), their \emph{disjoint union} is
    \[
        \bigsqcup_{i\in I}A_i= \bigcup_{i\in I}\{(x, i) \suchthat x \in A_i\}
    \]
    which consists of ordered pairs where the second element
