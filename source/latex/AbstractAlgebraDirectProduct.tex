...
\begin{plainhtml}
    The goal of the following definition is to construct a single group from various groups.
\end{plainhtml}
...
\begin{snippetproof}{external-direct-product-cyclicity-theorem-proof}{external-direct-product-cyclicity-theorem}{}
    \begin{enumerate}
        ...
        \begin{iffproof}
            \item Suppose at least two among \(d_i\) are not \coprime, for example \(d_1\) and \(d_2\),
            and let
            \\ \(d = \lcm(d_1, d_2) \neq 1\).  
            ...
            \item If \(d_1, d_2, \cdots, d_n\) are pairwise \coprime and \(g_1, g_2, \cdots, g_n\) are elements of
            \\ \(G_1, G_2, \cdots, G_n\)
...
\begin{plainhtml}
    The goal of the following definition is to decompose a single group into various groups.
\end{plainhtml}
...
\begin{plainhtml}
    The internal direct product and the external direct product are fundamentally the same concept.
\end{plainhtml}
