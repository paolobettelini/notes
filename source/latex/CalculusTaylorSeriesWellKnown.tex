...
\begin{snippetdefinition}{integral-sine-function-definition}{Integral sine function}
    The \emph{integral sine function} is defined as
    \[
        \operatorname{Si}(x) = \integral[0][x][\frac{\sin(t)}{t}][t]
    \]
\end{snippetdefinition}

\begin{snippetproposition}{integral-sine-function-maclaurin-series}{Integral sine function MacLaurin series}
    \[
        \operatorname{Si}(x) = \sum_{n=0}^\infty \frac{
            {(-1)}^n x^{2n+1}
        }{
            (2n+1)(2n+1)!
        }
