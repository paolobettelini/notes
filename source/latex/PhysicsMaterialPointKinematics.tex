...
\begin{snippetdefinition}{position-definition}{Position of a material point in a 3D space}
    The position of a particle is defined by a \snippetref[parametric-curve-definition][parametric curve] $\mathbf{r} : I \to \realnumbers^3 $, where $I \subseteq \realnumbers$ is a non-empty interval.
    \[
