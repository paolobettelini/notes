...
\begin{plainhtml}
    Defining convergence on topological spaces is a bit tricky because there is
...
\begin{plainhtml}
    This definition of convergence admits sequences that converge to multiple values.
...
\begin{plainhtml}
    In order to achieve uniqueness, we need to require disjoint open sets for every pair of distinct elements.
