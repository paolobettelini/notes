...
\begin{snippet}{catalisi-expl}
    ...
    quindi degli enzimi come catalizzatori.
\end{snippet}
...
\begin{snippet}{tipi-inibitore}
    ...
    \begin{itemize}
        \item \textbf{competitivo:} occupa il posto del reagente nello spazio attivo;
