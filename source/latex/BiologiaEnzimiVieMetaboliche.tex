...
\includesnpt[width=85\%|src=/snippet/static/reactions_cat.png]{centered-img}
...
\includesnpt[width=85\%|src=/snippet/static/enzym_cat.png]{centered-img}

\plain{L'enzima trascina i reagenti sullo stato di transizione.}

\includesnpt[width=80\%|src=/snippet/static/energy_reaction.png]{centered-img}
