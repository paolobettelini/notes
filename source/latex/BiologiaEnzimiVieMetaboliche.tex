...
\includesnpt[width=85\%|src=/snippet/static/reactions-cat.png]{centered-img}
...
\includesnpt[width=85\%|src=/snippet/static/enzym-cat.png]{centered-img}

\plain{L'enzima trascina i reagenti sullo stato di transizione.}

\includesnpt[width=80\%|src=/snippet/static/energy-reaction.png]{centered-img}
