...
\begin{snippetdefinition}{enzima-definizione}{Enzima}
    Gli \textit{enzimi} sono dei catalizzatori per aumentare le tempistiche delle varie reazioni chimiche.
\end{snippetdefinition}

\begin{snippetdefinition}{metabolismo-definizione}{Metabolismo}
...
\begin{snippet}{reactions-cat-illustration}
    \begin{center}
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.95\textwidth]{./resources/reactions_cat.png}
    \end{figure}
    \end{center}
\end{snippet}
...
\begin{snippet}{enzym-cat-illustration}
    \begin{center}
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.95\textwidth]{./resources/enzym_cat.png}
    \end{figure}
    \end{center}
\end{snippet}
...
\begin{snippet}{energy-reaction-illustration}
    \begin{center}
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.85\textwidth]{./resources/energy_reaction.png}
    \end{figure}
    \end{center}
\end{snippet}
...
\begin{snippetdefinition}{inibitore-enzimatico-definizione}{Inibitore enzimatico}
