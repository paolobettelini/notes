...
\begin{snippetdefinition}{ecologia-definizione}{Ecologia}
...
\begin{snippetdefinition}{ecosistema-definizione}{Ecosistema}
...
\begin{snippetdefinition}{popolazione-definizione}{Popolazione}
    Una \textit{popolazione} è un insieme di organismi della spessa
    speciale che vivono in una determinato posto.
\end{snippetdefinition}

\begin{snippetdefinition}{comunita-definizione}{Comunità}
