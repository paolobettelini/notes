...
A \snippetref[binary-operation-definition][binary operation] \(\circ\) on a finite set \(G\) can be
...
\begin{snippetdefinition}{monoid-definition}{Monoid}
    ...
    a binary operation \(\circ \colon G \cartesianprod G \to G\).
