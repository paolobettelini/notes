...
\begin{snippetdefinition}{topological-space-basis-definition}{Basis of topological space}
    ...
    A collection of \openset[open sets] \(\tbasis \subseteq \setT\)
...
\begin{snippetproof}{topology-from-arbitrary-basis-theorem-proof}{topology-from-arbitrary-basis-theorem}{}
    \begin{iffproof}
        \item The first condition is satisfied since \(X\) is open and \(\mathcal{B}\) is a \topologicalbasis.
        ...
        of \(\mathcal{B}\).
        \item We define \(\mathcal{T}\) as the collection of all the subsets
