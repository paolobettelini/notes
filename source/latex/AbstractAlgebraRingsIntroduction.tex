...
\begin{plainhtml}
    We can define the multiplication by an integer as repeated addition.
\end{plainhtml}
...
\begin{plainhtml}
    Using these properties we can prove prove that a negative times a negative is a positive.
\end{plainhtml}
...
\begin{plainhtml}
    In a commutative ring, every ideal is bilateral.
\end{plainhtml}
...
\begin{plainhtml}
    This does not work in general for the sum and union.
\end{plainhtml}
...
\begin{snippetproof}{ring-homomorphism-properties-proof}{ring-homomorphism-properties}{}
    \begin{enumerate}
        ...
        \item \begin{enumerate}
            ...
            \item \begin{iffproof}
                \item If \(\varphi\) is \injective,
                \(\varphi(0_A) = 0_B\) which means that \(\ringker \varphi = \{0_A\}\).
                \item If \(\ringker \varphi = \{0_A\}\), \(\forall a_1, a_2 \in A\) we have
                \[
                    \varphi(a_1) - \varphi(a_2) = \varphi(a_1 - a_2)
                \]
