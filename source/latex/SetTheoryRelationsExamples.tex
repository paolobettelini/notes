...
\begin{plainhtml}
    The same would not work if the sum needed to be odd, as the relation would not be reflexive and transitive.
\end{plainhtml}
...
\begin{plainhtml}
    In the integers this relation would not be antisymmetric.
\end{plainhtml}
