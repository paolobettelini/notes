...
\begin{snippet}{orlando-furioso-ottava-104-xxiii}
    ...
    Forse il nome Medoro è un riferimento ad Orlando, un soprannone.
    Questo è il secondo tentantivo della delusione e autoinganno.
\end{snippet}
...
\begin{snippet}{orlando-furioso-ottava-105-xxiii}
    ...
    I primi due versi constistono in una lotta psicologica di Orlando.
...
\begin{snippet}{orlando-furioso-ottava-109-xxiii}
    ...
    Medoro, lodando il lugoo, lascia un messaggio a chi verrà dopo, in maniera tale
...
\begin{snippet}{orlando-furioso-ottava-126-xxiii}
    ...
    domanda precendente e si interroga sulle sue lacrime.
    ...
    persona fosse un fludio interno al corpo.
\end{snippet}
...
\begin{snippet}{orlando-furioso-ottava-127-xxiii}
    ...
    quei \quotes{sospiri} fossero Amore (impersonificato)
...
\begin{snippet}{orlando-furioso-ottava-136-xxiii}
    ...
    \\\\
    Fino a metà dell'ottava si parla dei pastori che, in lontanana, sentono
