    ...
    \iffproof{
        \begin{enumerate}
            ...
            \item show that \(f\) is open.
                Let \(B\) be an \topologicalspace[open set][Open] in \(X\).
                We have that \(B = f^{-1}(A)\) for some \topologicalspace[open set][Open]
                \(A\) in \(Y\). Since \(f\) is a \topologicalimmersion
                \[
                    f(B) = f(f^{-1}(A)) = A \intersection f(X)
                \]
                which is thus \topologicalspace[open][Open].
        \end{enumerate}
    }{
        Let \(B\) be an \topologicalspace[open set][Open] in \(X\).
        We know that \(f(B)\) is \topologicalspace[open][Open] in \(f(X)\)
        and since \(f(B) = V \intersection f(X)\) for some \topologicalspace[open set][Open]
        \(V\) of \(Y\), it is also \topologicalspace[open][Open] in \(Y\).
        Since \(f\) is \injective we have \(B = f^{-1}(f(B))\)
        and thus \(B\) is the preimage of some \topologicalspace[open][Open] in \(Y\).
    }
\end{snippetproof}
