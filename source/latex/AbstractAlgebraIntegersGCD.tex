...
\begin{plainhtml}
    This definition is well-defined as the set of greatest common divisors is non-empty
...
\begin{plainhtml}
    This algorithms also works for polynomials (by restraining the orders of the terms).
\end{plainhtml}
...
\begin{plainhtml}
    These identities are not unique.
\end{plainhtml}
