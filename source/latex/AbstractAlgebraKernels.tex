...
\plain{This is because in general, elements with the same image form a lateral of the kernel.
Thus, we have as many images as many there are laterals, which reconnects to Lagrange's theorem.}
