...
\begin{snippetsolution}{topology-exercise-ex-5-sol}{}
    \begin{iffproof}
        ...
        Since \(X\) is \(T_1\), there exist an \openset[Open]
        ...
        \[
            \{x\} = \bigcap_{U \in I(x)} U
        \]
        \item Assume that \(\forall x \in X\)
        \[
            \{x\} = \bigcap_{U \in I(x)} U
        \]
...
\begin{snippetexercise}{topology-exercise-ex-6}{}
    ...
    Show that for every \openset[open][Open]
    \(U \subseteq X\), \(\overline{U \intersection A} = \overline{U}\).
\end{snippetexercise}

\begin{snippetsolution}{topology-exercise-ex-6-sol}{}
    \begin{doubleinclusion}
        \item This inclusion is trivial.
        \item We can state the condition of density as: \(U \intersection A \neq 0\), \(\forall U \neq \emptyset\) \openset[open][Open].
...
\begin{snippetsolution}{topology-exercise-ex-7-sol}{}
    \begin{enumerate}
        \item Let \(\tau_X\) be a topology for \(X\) and define \(C(A) = \overline{A}\).
            ...
            We will now prove (4).
                \begin{doubleinclusion}
                    \item Since \(A \union B \subseteq \overline{A} \union \overline{B}\),
                    then \(\overline{A \union B} \subseteq \overline{A} \union \overline{B}\).
                    \item Since \(A \subseteq \overline{A \union B}\)
        ...
        \begin{doubleinclusion}
            \item By property (1) and (2), \(C(A)\) is one such \set. Thus,
            \[
                \overline{A} =
                \bigcap_{\substack{B \text{ \closedset[closed]} \\ A \subseteq B}} B \subseteq C(A)
            \]
            \item Since \(B \subseteq A\), we have \(A \union B = B\),
...
\begin{snippetproof}{constant-topological-maps-are-continuous-proof}{constant-topological-maps-are-continuous}{}
    ...
    \[
        ...
        \end{cases}
    \]
    which are both \openset[open][Open].
\end{snippetproof}
...
\begin{snippetproof}{topological-identity-map-continuity-equivalence-proof}{topological-identity-map-continuity-equivalence}{}
    \begin{iffproof}
        \item Let \(A \in \tau_2\). We have
        \[
            \text{id}^{-1}(A) = A \in \tau_1
        \]
        \item If \(\tau_2 \subseteq \tau_1\), we have
        \[
            \text{id}^{-1}(A) = A \in \tau_1
        \]
        which is \openset[open][Open].
    \end{iffproof}
\end{snippetproof}
