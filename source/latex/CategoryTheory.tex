...
\begin{plainhtml}
    The dual category is the same category but with every morphism inverted.
\end{plainhtml}
...
\begin{plainhtml}
    An epimorphism is a morphism that is right-cancellable.
...
\begin{plainhtml}
    A monomorphism is a morphism that is left-cancellable.
...
\begin{plainhtml}
    Note that every isomorphism is both mono and epic, but the converse is not true in general.
