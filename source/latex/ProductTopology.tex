...
\begin{plainhtml}
    We want to naturally induce the least coarse topology for the cartesian product of spaces.
\end{plainhtml}
...
\begin{plainhtml}
    We want to find the least coarse topology such that the two projections are continuous.
\end{plainhtml}
...
\begin{snippetproof}{product-topology-is-topology-proof}{product-topology-is-topology}{Product topology is a topology}
    ...
    The collection of subsets \(\{U \cartesianprod V \suchthat U \text{ \openset[open] in } X \land V \text{ \openset[open] in } Y\}\)
...
\begin{plainhtml}
    The product topology between spaces is associative up to homeomorphism.
\end{plainhtml}
    ...
    \begin{enumerate}
        \item[2.] The restrictions are obtained via composition of continuous maps.
            \begin{center}
                ...
                \end{tikzcd}
            \end{center}
            To study whether the maps are open, we characterize the \openset[open sets]
            of \(P \cartesianprod \{y\}\) and \(\{x\} \cartesianprod Q\).
            Consider a generic \openset of the standard \topologicalbasis
            ...
            \[
                ...
                \end{cases}
            \]
            This means that the \openset[open sets] are precisely the subsets
            of the form \(U \cartesianprod \{y\}\) for some \openset
            of \(X\) \[ \restr{p}{P \cartesianprod \{y\}}(U \cartesianprod \{y\}) = U \]
            The same goes for \(q\).
        \item[1.] We want to show that \(p(Q)\) is an \openset of \(P\).
        ...
        \]
        which is \openset[open] in \(P\) as union of \openset.
        The same goes for \(q\). 
        ...
        We know that \(f\) is continuois \ifandonlyif for all \openset[open sets]
        of the standard \topologicalbasis of \(P \cartesianprod Q\),
        \(f^{-1}(U \cartesianprod V)\) is \openset[open] in \(X\)- We have
        \begin{align*}
            f^{-1}(U \cartesianprod V) &= f^{-1}(p^{-1}(U) \intersection q^{-1}(V)) \\
            &= f^{-1}(p^{-1})(U) \intersection f^{-1}(q^{-1}(V)) \\
            &= {(p \circ f)}^{-1}(U) \intersection {(q \circ f)}^{-1}(V)
        \end{align*}
        which is \openset[open] as intersection of
        \openset[open sets] by the continuity of the composition.
    \end{enumerate}
\end{snippetproof}
