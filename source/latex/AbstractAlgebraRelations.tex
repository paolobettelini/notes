...
\begin{plainhtml}
    Every element of an equivalence classe determines the class itself (it is representative).
\end{plainhtml}
...
\begin{snippetproof}{binary-relation-equivalence-condition-proof}{binary-relation-equivalence-condition}{Equivalence condition for binary relation}
    ...
    Let \(a,b,c\in A\)
    \begin{iffproof}
        \item Since \(\sim\) is transitive, we have that \(a \sim b \land b \sim c \implies a \sim c\).
