...
\begin{plainhtml}
    The condition of containing the identity in a group can be replaced
...
\begin{snippetproof}{one-step-subgroup-test-proof}{one-step-subgroup-test}{One-Step Subgroup Test}
    \begin{iffproof}
        \item Assume \((H, \circ) \subgroupleq (G, \circ)\).
        The properties of a \group directly infer \(\forall a,b \in H, a \circ b^{-1} \in H\).
        \item Assume \(\forall a,b \in H, a \circ b^{-1} \in H\) and \(H \neq \emptyset\):
        \begin{itemize}
...
\begin{snippetproof}{finite-subgroup-test-proof}{finite-subgroup-test}{Finite subgroup test}
    \begin{iffproof}
        ...
        \item Assume \(\forall a,b \in H, ab \in H\) and \(H \neq \emptyset\).
...
\begin{plainhtml}
    The intersection of a submonoid is a monoid (if in the definition we require the two identity elements
    to be the same).
\end{plainhtml}
...
\begin{plainhtml}
    The same does not work for the union.
\end{plainhtml}
