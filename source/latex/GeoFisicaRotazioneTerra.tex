...
\section{Velocità di rotazione}

\begin{snippet}{velocita-lineare-rotazione}
  La velocita lineare di rotazione è data dal rapporto tra la distanza 
  percorsa da un punto in rotazione e il tempo t necessario per compiere lo spostamento
  È massima all'equatore e diminuisce verso i poli.
\end{snippet}
