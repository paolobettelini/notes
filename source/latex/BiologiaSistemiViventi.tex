...
\begin{plainhtml}
    Il sistema vivente presenta le medesima caratteristiche del sistema non-vivente,
...
\begin{plainhtml}
    Ogni essere vivente possiede autopoiesi, dissipazione e cognizione.
\end{plainhtml}
