...
\begin{plainhtml}
    The partial derivative is like taking a slice of the multidimensional function
...
\begin{plainhtml}
    The existence of partial derivatives does not imply differentiability.
...
\begin{plainhtml}
    If f is differentiable at a, we can define the tangent hyperplane
    as f(a) + ∇f(a) · (x - a).
\end{plainhtml}
...
\begin{plainhtml}
    By the total differential theorem, the C classes are nested.
\end{plainhtml}
