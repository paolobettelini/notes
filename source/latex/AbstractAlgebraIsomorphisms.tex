...
\begin{plainhtml}
    In the case of a group, the morphism property with the cancellation law implies that property of the identity element.
\end{plainhtml}
...
\begin{plainhtml}
    The same goes for a monoid, with the addition need to check that the identity is preserved.
\end{plainhtml}
...
\begin{plainhtml}
    An element of finite period cannot be sent into one of infinite period. However, the opposite is possible.
\end{plainhtml}
...
\begin{plainhtml}
    This also works in a monoid as the definition requires the identity to be preserved.
\end{plainhtml}
