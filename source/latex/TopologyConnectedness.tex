...
\begin{plainhtml}
    If there were other such sets, then the space would be homeomorphic to the disjoint union of the set and its complement.
\end{plainhtml}
...
\begin{plainhtml}
    Every convex real hyperdimensional subset is arc connected.
\end{plainhtml}
