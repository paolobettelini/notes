...
\begin{snippetproof}{topology-t2-implies-t1-proof}{topology-t2-implies-t1}{}
    ...
    \(X \difference \{x\}\) is \openset[open].
...
\begin{snippetproof}{hausdorff-space-diagonal-characterization-proof}{hausdorff-space-diagonal-characterization}{}
    ...
    \(\forall x \neq y\) there exist \openset[open sets] \(U\) and \(V\)
...
\begin{plainhtml}
    If the two spaces are equal, the solutions to the fixed point equation is closed.
\end{plainhtml}
