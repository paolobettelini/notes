...
\begin{plainhtml}
    There are subsets in the rationals without a supremum.
\end{plainhtml}
...
\begin{plainhtml}
    The reals can also be defined using Cauchy sequences or Dedekind cuts
\end{plainhtml}
...
\begin{plainhtml}
    Between every two reals, there exist (infinite) rationals. This means that the rationals are dense in the reals.
\end{plainhtml}
