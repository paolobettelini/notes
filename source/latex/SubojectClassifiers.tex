...
\begin{plainhtml}
    The following is a generalization of subsets.
\end{plainhtml}
...
\begin{plainhtml}
    Subojects are classes of monomorphisms in the slice category if there is an isomorphism between them that makes the triangle commute.
\end{plainhtml}
