...
\begin{plainhtml}
    The support is the empty set if and only if the permutation is the identity function.
...
\begin{plainhtml}
    Any k-cycle can be written in k different ways and it has a period of k.
\end{plainhtml}
...
\begin{plainhtml}
    The uniqueness is given by the fact that disjoint cycles commute.
\end{plainhtml}
