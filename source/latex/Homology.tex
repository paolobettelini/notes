...
\begin{plainhtml}
    By identifying simplices along their faces, we get a simplicial complex.
\end{plainhtml}
...
\begin{plainhtml}
    We want to use simplices to convert information about shape (holes and such)
...
\begin{plainhtml}
    This group is always abelian. Usually the additive integer group is used.
\end{plainhtml}
...
\begin{plainhtml}
    By the fundamental property of the boundary operator, every boundary is a cycle.
\end{plainhtml}
