...
\begin{plainhtml}
    decompositori sono generalmente unicellulari, e si nutrono di grandi detriti per farli diventare
    detriti più piccoli.
\end{plainhtml}
...
\begin{plainhtml}
    Due specie diverse non possono condividere la stessa nicchia.
\end{plainhtml}
