...
\begin{plainhtml}
    We can construct n² partial derivatives and form a square matrix.
\end{plainhtml}
...
\begin{plainhtml}
    The existence of one mixed partial derivative does not imply
...
\begin{plainhtml}
    These classes are nested: \(\continuityclass^{k+1
\end{plainhtml}(\Omega) \subseteq \continuityclass^k(\Omega)\).}
