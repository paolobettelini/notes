...
\plain{
    Interessante la contrapposizione degli aggettivi tra la terzina che descrive l'inferno e quella che 
    descrive il purgatorio: \quotes{disperare} - \quotes{sperare}, \quotes{dolenti} - \quotes{contenti}.
}
...
\begin{snippet}{inferno-canto-i-124}
    ...
    Virigilio è \quotes{ribellante} della legge di Dio, non perché abbia fatto qualcosa di male,
