...
\begin{snippet}{inferno-canto-i-103}
    ...
    La prima interpretazione è quella di intendere il feltro come un panno file,
    ...
    lo collega alla collocazione geografica di Verona, la quale si situa tra Feltro e Montefeltro, per cui
    nascerà a Verona.
    L'ultima interpretazione, quela più accreditata, dice che il veltro nascerà da un'elezone imperiale,
