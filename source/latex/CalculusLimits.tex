...
\begin{snippetdefinition}{extended-real-accumulation-point-definition}{Accumulation point in the extended reals}[\generalizations{accumulation-point-definition}]
...
\begin{plainhtml}
    An extended accumulation point is a point for which there exist a sequence that converges to it.
\end{plainhtml}
...
\begin{plainhtml}
    A limit exists if and only if the left-hand limit and the right-hand limit exist and are equal.
\end{plainhtml}

\section{Results}

\begin{plainhtml}
    The following theorem acts as a bridge to allow us to use the propositions around limits of successions as
    limits of functions.
\end{plainhtml}
...
\begin{snippetproof}{limit-of-sequence-function-bridge-theorem-proof}{limit-of-sequence-function-bridge-theorem}{}
    \begin{iffproof}
        ...
        \item We will prove the contrapositive. Let \(\xi \in \realnumbers\) such that the \neighborhood \(J\) of \(\xi\)
