...
\begin{plainhtml}
    Determining whether an object is in a set or not is often a difficult task. For example,
    if we consider the set of prime numbers it is often computationally hard to tell whether the element is in the set.
\end{plainhtml}

\begin{plainhtml}
    To describe a finite set it is possible to list every element inside it.
\end{plainhtml}
...
\begin{plainhtml}
    Note that order and repetitions are not relevant.
\end{plainhtml}
