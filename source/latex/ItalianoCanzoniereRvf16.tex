...
\begin{snippet}{canzoniere-rvf-16-parte1}
    ...
    \StellarPoetry{1}{
        ...
        \parbox[t]{0.4\textwidth}{Il vecchietto canuto e imbiancato dall'età si separa
        \textbf{/}dal suo tranquillo paese natale, che lo ha nutrito per l'intero numero dei suoi anni (dove ha trascorso tutta la vita),
        \textbf{/}e dalla sua famiglia, commossa
        \textbf{/}che vede il caro padre partire;}
    }
    \StellarPoetry{5}{
        indi trahendo poi l'antiquo fianco \\
        per lvextreme giornate di sua vita, \\
        quanto piú pò, col buon voler s'aita, \\
        rotto dagli anni, et dal camino stanco;
    }{
        \parbox[t]{0.4\textwidth}{da lì, trascinando a fatica le vecchie membra (\quotes{l'antiquo fianco})
        \textbf{/}attraverso le ultime giornate della sua vita,
        \textbf{/}si fa coraggio quanto più può con la buona volontà,
        \textbf{/}sfiancato dagli acciacchi dell'età e affaticato dal cammino;}
    }
    \StellarPoetry{9}{
        ...
        \parbox[t]{0.4\textwidth}{e viene a Roma, seguendo il suo desiderio
        \textbf{/}di vedere il cosiddetto velo della Veronica, l'immagine di Cristo
        \textbf{/}che spera di poter vedere di nuovo in cielo, dopo la morte (\quotes{ancor}):}
    }
    \StellarPoetry{12}{
        ...
        \parbox[t]{0.4\textwidth}{allo stesso modo, a volte cerco io, sfinito,
        \textbf{/}Laura, per quanto possibile, in altre donne
        \textbf{/}il vostro desiderato volto in carne e ossa.}
    }
