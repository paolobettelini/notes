...
\section*{Abstract}
Intersection between a ray starting from an origin and a sphere.\\
This computation is often used in rendering techniques such as ray tracing.
...
\begin{center}
	\begin{tikzpicture}[scale=2]
		...
		\draw [->] (1.49,1.9,2.69) -- (2.87,3.1,3.51) node [above right] {\(t\vec{d}\)};
