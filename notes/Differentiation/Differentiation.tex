...
\begin{itemize}
    \item If \(f''(x)<0\) then \(x=c\) is a relative maximum.
    \item If \(f''(x)>0\) then \(x=c\) is a relative minumum.
    \item If \(f''(x)=0\) then \(x=c\) could be a relative maximum, minimum or neither.
\end{itemize}
