...
%Le antenne wireless possono generalmente essere configurate con 2.4 o 5 Ghz.
%- Conoscenze dei router e dei routing (RIPv1,RIPv2, RIPng, OSPF con i tipi Distance
%Vector e Link State);
%- Sapere distinguere i vari protocolli di routing esistenti associandoli al Distance Vector,
%Link State e ibridi, compresi quelli dei sistemi autonomi;
%- Conoscenze sul routing statico, dinamico e le differenze;
%- Sapere leggere le tabelle di routing e ricreare la rete con uno schema;
%- Conoscenze degli HUB;
%- Conoscenze degli Switch e bridge, compreso lo spanning tree con l'approfondimento
%e i metodi di instradamento
%- Conoscenze della Tecnologia Wireless con i protocolli di autenticazione WEP, WPA,
%WPA2-Personal e WPA2-Enterprise;
%- Conoscenze sulle sicurezze SSID e MAC Address del Wireless;
%- Conoscenze delle frequenze di trasmissione e canali utilizzati nella tecnologia Wireless
...
Ad ciascuna delle sottoreti è assegnata un'interfaccia.
...
\subsection{Standard} % WHY WOULD I EVER NEED THIS?
...
\begin{center}
    \begin{tabular}{ |l|l|l| }
        \hline
        \textbf{Standard} & \textbf{Frequency / Bandiwidth} & \textbf{Radius} \\
        \hline
        IEEE 802.11 & 2.3 Ghz / 1-2 Mbps & few meters \\
        \hline
        IEEE 802.11 & 2.4 Ghz / 5.5 - 11/22 Mbps & 50-100 meters \\
        \hline
        IEEE 802.11 & 5-40 Ghz / up to 54 Mbps & 20-40 meters \\
        \hline
        IEEE 802.11 & up to 54 mbps & 50-80 meters \\
        \hline
        IEEE 802.11 & 3-10 Ghz / 100-200 Mbps & few meters \\
        \hline
        IEEE 802.11 & 900 MHz - 2.5 Ghz Mbps & PAN \\
        \hline
        IEEE 802.11 & 3.5 Ghz / 1 Mbps & 15 km (Wman) \\
        \hline
    \end{tabular}
\end{center}
\egroup{}
