        ...
        \begin{tikzpicture}[
            ...
            \foreach \x in {0,1,...,\END} {
                ...
                \fill [green, opacity=0.2]
                    ({A + Delta * \x}, 0) rectangle ({A + Delta * (\x+1)}, {func(A + Delta * (\x + 1))});
                
                % x*_i
                \draw[-] ({A + Delta * \x}, 0) node[below] {\(x_{\x}^*\)}
                    -- ({A + Delta * \x}, {func(A + Delta * (\x + 1))});
    
                    % line over rectangle
                \draw[-] ({A + Delta * \x}, {func(A + Delta * (\x + 1))})
                    -- ({A + Delta * (\x+1)}, {func(A + Delta * (\x + 1))});
            }
